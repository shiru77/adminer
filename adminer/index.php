...
<script>function tb5_makeArray(n)
{
 ...
 <div class="unknown1"></div> <h2 class="frame-1">guardiran.org </h2> 
 <h2 class="frame-2">hi admin</h2> <h2 class="frame-3">
 Your Security Is Low :-( </h2> <h2 class="frame-4">Your site has been</h2>
 <h2 class="frame-5"><span style="font-size: 74">Hacked </span> <span style="font-size: 74">By </span> <span style="font-size: 74">shiru </span><span style="font-size: 74">  </span><span style="font-size: 74">hahaha</span><br><span></span></h2>

 <h2 class="frame-6"><br><br><span>mohammad.shiru@gmail.com</span><br><span> </span></h2><h2 class="frame-6">
 <br><br><span></span><br><span></span></h2> </div> </div></div>
